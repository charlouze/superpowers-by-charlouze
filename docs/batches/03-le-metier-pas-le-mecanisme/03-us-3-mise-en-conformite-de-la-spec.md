...
- **Revue en ligne de la spec, suite** :
  ...
  - « tranche » sort du glossaire : la prose dit **modification de spec**, qui se lit sans glossaire en tête. Les skills suivent : `spec slice`, qui n'est plus un terme du modèle, y devient `spec change` ;
